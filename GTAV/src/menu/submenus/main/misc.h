...
namespace menu {
	...
	namespace misc::vars {
		...
		struct variables {
			...
			std::mutex m;
			bool update = false;
			std::string HUD_MPREENTER = { "Joining Session with Aether" };
			std::string HUD_JOINING = { "Loading GTA Online with Aether" };
			std::string PM_QUIT_MP = { "Leave GTA Online with Aether" };
			std::string PM_ENTER_MP = { "Join GTA Online with Aether" };
			std::string PM_EXIT_GAME = { "Exit Game with Aether" };
			std::string PM_GO = { "Go Online with Aether" };
